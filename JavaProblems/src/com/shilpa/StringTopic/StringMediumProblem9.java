...
public class StringMediumProblem9 {
...
/*
 ...
 m.group(i) is the ith match.
 So m.group(1) is the 1st match (which is enclosed in the 1st set of parentheses)

 The ?: is added to make it a "non-capturing group" (meaning you can't do group() to get the group), for
