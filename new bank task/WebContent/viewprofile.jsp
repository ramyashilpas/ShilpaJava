...
<h2 align="center" Style="margin-left:0px;"><b>View Your Profile</b></h2>
<br>
...
<table  align="center" >
   ...
   <td> <input type="text" name="C_Id"  placeholder="Enter Cust_Id eg:100"/><br></td></tr>
    ...
    <tr><td align="center" ><button type="submit" class="btn btn-success" value="view profile" >View Profile</button></td>
      <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
       <td><a href="viewprofile.jsp"><button type="button"value="cancel" class="btn btn-danger">Cancel</button> </a> </td>
     </tr>
    <tr><td><br></td></tr>
     <tr><td><br></td></tr>
      <tr><td><br></td></tr>   
