...
<html>
<head><title>SYS Bank</title><link rel="shortcut icon" href="images/barclays.png" type="image/png"/>
...
<li><a  class="nav navbar-nav" href="viewprofile.jsp">View profile</a></li>
...
<li><a  class="nav navbar-nav" href="closeaccount.jsp">Close Account</a></li>
 ...
 <br>
 <br>
 <h1 id="welcome"><marquee behavior="slide" direction="right"><b style="font-family:French Script MT;font-style:bold;">Welcome to SYS</b></marquee></h1> 
<!-- <img src="images/logobarclays.png" align="bottom" style="margin-left:470px;height:40px;width:470px;margin-top:50px;"></img> -->
</body>
<br>
 <br>
 <br>
